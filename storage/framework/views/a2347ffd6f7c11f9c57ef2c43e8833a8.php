            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="accountDropdown">
                    <?php if(Auth::check()): ?>
                        ...
                        <li><a class="dropdown-item" href="<?php echo e(route('profile.profile-all')); ?>">Mis datos</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('profile.profile-all')); ?>#resenas-pane">Mis Reseñas</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('profile.profile-all')); ?>#favoritos-pane">Favoritos</a></li>
                        <li>
...
</html><?php /**PATH C:\wamp64\www\bcnrestaurantes\resources\views/layouts/plantilla_restaurante.blade.php ENDPATH**/ ?>