...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'BcnRestaurantes'); ?></title>
    ...
    <header class="bg-light border-bottom py-3">
        <div class="container d-flex align-items-center justify-content-between">
            <a href="#" class="navbar-brand">
                <img src="<?php echo e(asset('img/bcn-logo.png')); ?>" alt="Logo" height="40">
            </a>
...
<?php /**PATH C:\wamp64\www\bcnrestaurantes\resources\views/layouts/app.blade.php ENDPATH**/ ?>