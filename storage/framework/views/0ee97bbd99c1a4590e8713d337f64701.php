...
<body>
    <header class="bg-white text-dark py-2 d-none d-lg-block">
        <div class="container d-flex justify-content-between align-items-center">
            <img src="<?php echo e(asset('img/bcn-logo.png')); ?>" class="logo h4 mb-2 mb-lg-0" alt="Logo BCN">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="accountDropdown">
                        <?php if(Auth::check()): ?>
                            ...
                            <li><a class="dropdown-item" href="<?php echo e(route('user.edit')); ?>">Mis datos</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('user.edit')); ?>">Mis Opiniones</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('user.edit')); ?>">Favoritos</a></li>
                            <li>
...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #f26522;">
    ...
    <a class="navbar-brand d-lg-none" href="#">
        <img src="<?php echo e(asset('img/bcn-logo.png')); ?>" class="logo" alt="Logo BCN" style="height: 40px;">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarContent">
        ...
        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('login')); ?>">Inicio</a></li>
        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('views.restaurantes')); ?>">Restaurantes</a></li>
        <li class="nav-item"><a class="nav-link" href="#">Categorías</a></li>
        <li class="nav-item"><a class="nav-link" href="#">Colecciones</a></li>
        <li class="nav-item"><a class="nav-link" href="#">Community</a></li>
        
        <?php if(Auth::check() && Auth::user()->rol_id == 2): ?>
                ...
                <div class="modal-body">
                    <form id="login-form" action="<?php echo e(route('login')); ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" id="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" onblur="validateEmail(this)">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('register')); ?>" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="email" class="form-label">Correo electrónico:</label>
                            <input type="email" id="email_register" name="email" class="form-control" value="<?php echo e(old('email')); ?>">
    ...
    <script src="<?php echo e(asset('js/form_modal.js')); ?>"></script>
    <script src="<?php echo e(asset('js/validation_login.js')); ?>"></script>
    <script src="<?php echo e(asset('js/validation_register.js')); ?>"></script>

    <script>
        document.addEventListener('DOMContentLoaded', function () {
            <?php if(session('modal') == 'login-modal' || $errors->any()): ?>
                const loginModal = new bootstrap.Modal(document.getElementById('loginModal'));
                loginModal.show();
            <?php endif; ?>

            <?php if(session('showRegisterModal')): ?>
...
</html><?php /**PATH C:\wamp64\www\bcnrestaurantes\resources\views/auth/login.blade.php ENDPATH**/ ?>